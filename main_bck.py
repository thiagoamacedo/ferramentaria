...
telaFerramenta.btnDeletar.place(relx=0.37, rely=0.380, height=30, width=70)
...
telaFerramenta.btnInserir.place(relx=0.42, rely=0.380, height=30, width=70)
...
telaFerramenta.btnEditar.place(relx=0.47, rely=0.380, height=30, width=70)
...
telaTecnico.btnDeletar.place(relx=0.37, rely=0.380, height=30, width=70)
...
telaTecnico.btnInserir.place(relx=0.42, rely=0.380, height=30, width=70)
...
telaTecnico.btnEditar.place(relx=0.47, rely=0.380, height=30, width=70)
...
telaEmprestimo.btnConfirmar.configure(command=lambda: reservarFerramenta())
